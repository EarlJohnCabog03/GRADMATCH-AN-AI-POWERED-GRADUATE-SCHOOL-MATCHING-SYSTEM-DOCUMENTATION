...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GradMatch AI — Find your perfect graduate program" },
      { name: "description", content: "AI-powered graduate-school matching, admissions odds, SOP coaching, and application tracking." },
      { property: "og:title", content: "GradMatch AI" },
      { property: "og:description", content: "AI-powered graduate-school matching, admissions odds, SOP coaching, and application tracking." },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    const handle = async () => {
      try {
        // Newer Supabase clients may not expose getSessionFromUrl.
        // We don't strictly need to handle it here; session restoration is handled by auth state.
        // If you use URL-based login links, implement your own URL session handler.
  ...
  // Lovable dev tagger has been disabled in Vite config; no runtime cleanup required.
  return (
